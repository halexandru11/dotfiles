# Generated by Powerlevel10k configuration wizard on 2023-08-07 at 11:00 EEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='󱞶' #'❮'
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=202
  ...
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_FOREGROUND=2
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_BACKGROUND=126
  ...
  typeset -g POWERLEVEL9K_FVM_BACKGROUND=27
  # Custom icon.
