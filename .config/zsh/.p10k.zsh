# Generated by Powerlevel10k configuration wizard on 2024-02-18 at 01:04 EET.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=12
  ...
  typeset -g POWERLEVEL9K_VCS_COMMITS_BEHIND=' ' 
  typeset -g POWERLEVEL9K_VCS_COMMITS_AHEAD=' '
  typeset -g POWERLEVEL9K_VCS_PUSH_COMMITS_BEHIND=' '
  typeset -g POWERLEVEL9K_VCS_PUSH_COMMITS_AHEAD=' '
  typeset -g POWERLEVEL9K_VCS_STASHES=' '
  typeset -g POWERLEVEL9K_VCS_STATUS_WIP='󱁤 '
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_CONFLICTED='󱠇 '
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_STAGED=' '
  typeset -g POWERLEVEL9K_VCS_STATUS_NUM_UNSTAGED=' '
  ...
  function my_git_formatter() {
    ...
    if [[ $VCS_STATUS_COMMIT_SUMMARY == (|*[^[:alnum:]])(wip|WIP)(|[^[:alnum:]]*) ]]; then
      res+=" ${modified}${POWERLEVEL9K_VCS_STATUS_WIP}"
    fi

    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      # ⇣42 if behind the remote.
      (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${POWERLEVEL9K_VCS_COMMITS_BEHIND}${VCS_STATUS_COMMITS_BEHIND}"
      # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
      (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
      (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_COMMITS_AHEAD}${VCS_STATUS_COMMITS_AHEAD}"
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${POWERLEVEL9K_VCS_PUSH_COMMITS_BEHIND}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_PUSH_COMMITS_AHEAD}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}${POWERLEVEL9K_VCS_STASHES}${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${POWERLEVEL9K_VCS_STATUS_NUM_CONFLICTED}${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${POWERLEVEL9K_VCS_STATUS_NUM_STAGED}${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${POWERLEVEL9K_VCS_STATUS_NUM_UNSTAGED}${VCS_STATUS_NUM_UNSTAGED}"
